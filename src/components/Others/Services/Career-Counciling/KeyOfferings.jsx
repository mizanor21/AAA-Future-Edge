    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 text-center sm:grid-cols-2 gap-y-8 lg:grid-cols-4 sm:gap-12">
            <div>
                ...
                <h3 class="mt-8 text-lg font-semibold text-black">Career Assessments</h3>
                <p class="mt-4 text-sm text-gray-600">Our key offerings are designed to support individuals at various stages of their career journey</p>
            </div>
            ...
            <div>
                ...
                <h3 class="mt-8 text-lg font-semibold text-black">Resume and Cover letter writing</h3>
                <p class="mt-4 text-sm text-gray-600"> our resume and cover letter writing services help clients craft professional and impactful documents that stand out to employers</p>
            </div>
            ...
            <div>
                ...
                <h3 class="mt-8 text-lg font-semibold text-black"> Interview Coaching</h3>
                <p class="mt-4 text-sm text-gray-600">For those preparing for job interviews, our interview coaching offers essential practice and feedback</p>
            </div>
            ...
            <div>
                ...
                <h3 class="mt-8 text-lg font-semibold text-black">Job Search Strategies</h3>
                <p class="mt-4 text-sm text-gray-600">We provide job search strategies to assist clients in navigating the job market effectively</p>
            </div>
        </div>
    </div>
</section>
